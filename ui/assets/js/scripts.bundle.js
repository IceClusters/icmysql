    ...
    var i = {
      ...
      r = function () {
        (n.options = KTUtil.deepExtend({}, i, t)),
          ...
          d("decimals") && (n.options.decimals = parseInt(d("decimals"))),
          d("prefix") && (n.options.prefix = d("prefix")),
          d("suffix") && (n.options.suffix = d("suffix")),
          d("step") && (n.options.step = parseFloat(d("step"))),
          d("min") && (n.options.min = parseFloat(d("min"))),
          d("max") && (n.options.max = parseFloat(d("max"))),
  ...
  if (null != e) {
    var r = {
      ...
      d = function () {
        ...
        "on" === String(i.getAttribute("data-kt-drawer-" + n.name + "-"))
          ? (n.shown = !0)
          : (n.shown = !1),
          !0 === f("activate")
    ...
    KTUtil.data(e).has("drawer") ? (n = KTUtil.data(e).get("drawer")) : o(),
      (n.toggle = function () {
        return l();
      }),
      (n.show = function () {
        ...
        if (!0 === KTUtil.data(t).has(n)) {
          ...
          if (e[n] && e[n][o]) {
            ...
            if (a.name === n) {
              ...
              if (0 == a.fired)
                return (e[n][o].fired = !0), a.callback.call(this, i, r);
            }
          }
        }
        return null;
...
var KTMenu = function (e, t) {
  ...
  if (null != e) {
    var i = {
      ...
      a = function (e) {
        e || (e = n.triggerElement),
          !0 !== m(e) &&
            ("dropdown" === v(e) ? E(e) : "accordion" === v(e) && S(e),
      ...
      K = function (e) {
        ...
        return (
          ...
          (null !== t && t.querySelector(".menu-item[data-kt-menu-trigger]")) ||
            null
        );
      },
      U = function (e) {
      ...
      S = function (e) {
        if (
          !1 !== KTEventHandler.trigger(n.element, "kt.menu.accordion.show", e)
        ) {
      ...
      A = function (e) {
        if (
          !1 !== KTEventHandler.trigger(n.element, "kt.menu.accordion.hide", e)
        ) {
          var t = g(e);
    ...
    !0 === KTUtil.data(e).has("menu") ? (n = KTUtil.data(e).get("menu")) : r(),
      ...
      (n.link = function (e, t) {
        !1 !== KTEventHandler.trigger(n.element, "kt.menu.link.click", n) &&
          (KTMenu.hideDropdowns(),
          KTEventHandler.trigger(n.element, "kt.menu.link.clicked", n));
      }),
      ...
      a = function () {
        ...
        !1 === n.element.hasAttribute("data-kt-scroll-activate")
          ? ((e = d()),
            ...
            !0 === u("save-state") && void 0 !== KTCookie && n.id
    ...
    var i = {
      ...
      c = function () {
        !1 !== KTEventHandler.trigger(n.element, "kt.search.clear", n) &&
          ...
          n.inputElement.focus(),
          n.clearElement && n.clearElement.classList.add("d-none"),
          n.toolbarElement && n.toolbarElement.classList.remove("d-none"),
          !1 === g("show-on-focus") && p(),
            ...
            e.getAttributeNames().forEach(function (n) {
              if (/^data-tns-.*/g.test(n)) {
                ...
                if ("data-tns-responsive" === n) {
                  ...
                  t[r] =
                    "true" === (i = e.getAttribute(n)) || ("false" !== i && i);
              }
              var i;
            });
